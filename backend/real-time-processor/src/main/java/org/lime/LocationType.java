...
public class LocationType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LocationType\",\"namespace\":\"org.lime.lakeglue\",\"fields\":[{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"lat\",\"type\":\"double\"},{\"name\":\"long\",\"type\":\"double\"}]}");
   ...
   */
  public LocationType(CharSequence email, Long timestamp, Double lat, Double long$) {
    this.email = email;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
      ...
      case 2: lat = (Double)value$; break;
      case 3: long$ = (Double)value$; break;
      default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static LocationType.Builder newBuilder() {
    return new LocationType.Builder();
  }

  /** Creates a new LocationType RecordBuilder by copying an existing Builder */
  public static LocationType.Builder newBuilder(LocationType.Builder other) {
    return new LocationType.Builder(other);
  }

  /** Creates a new LocationType RecordBuilder by copying an existing LocationType instance */
  public static LocationType.Builder newBuilder(LocationType other) {
    return new LocationType.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LocationType>
    ...
    private Builder() {
      super(LocationType.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(LocationType.Builder other) {
      super(other);
    ...
    private Builder(LocationType other) {
      super(LocationType.SCHEMA$);
      if (isValidValue(fields()[0], other.email)) {
        this.email = data().deepCopy(fields()[0].schema(), other.email);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'email' field */
    public LocationType.Builder setEmail(CharSequence value) {
    ...
    public LocationType.Builder clearEmail() {
      email = null;
    ...
    /** Sets the value of the 'timestamp' field */
    public LocationType.Builder setTimestamp(long value) {
    ...
    public LocationType.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'lat' field */
    public LocationType.Builder setLat(double value) {
    ...
    public LocationType.Builder clearLat() {
    ...
    /** Sets the value of the 'long$' field */
    public LocationType.Builder setLong$(double value) {
    ...
    public LocationType.Builder clearLong$() {
    ...
    public LocationType build() {
      try {
        ...
        record.lat = fieldSetFlags()[2] ? this.lat : (Double) defaultValue(fields()[2]);
        record.long$ = fieldSetFlags()[3] ? this.long$ : (Double) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
